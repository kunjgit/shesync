...
import 'package:shesync/period_tracking/tips.dart';
import 'package:shesync/period_tracking/tips_card.dart';
...
class _HealthTipsState extends State<HealthTips> {
  List<HealthTip> health_tips=[
    HealthTip(tip: 'Attitudes & healthy periods',
     ...
     HealthTip(tip:'Exercise, diet & periods', author: 'Kusha', content: "Diet and exercise bring a range of health benefits as well as improving your experience of having periods. Studies have found that women who exercise regularly are less likely to suffer menstrual pain, cramps and mood disturbance. We are not certain why exercise is helpful for PMS but studies demonstrate that exercise can release ‘happy’ hormones such as serotonin and endorphins, which may explain the benefit."),
      HealthTip(tip:'Sleep, sunshine & vitamin D', author: 'Yash', content: "Sleep, sunshine and vitamin D play a vital role in our general health and may help to improve our menstrual health as well.Studies have found that sleep disturbance is common in women who suffer severe PMS. Poor sleep can also contribute to mood disturbance, hormone irregularities and disturbed menstrual cycles"),
       HealthTip(tip: 'Physical therapies', author: 'Kruti', content: "There are many alternative approaches that aim to improve the experience of menstruation. Some are supported by good evidence while others may simply improve women's sense of wellbeing.Research suggests some physical therapies such as local heat application (heat packs), TENS (transcutaneous electrical nerve stimulation), acupuncture and acupressure are helpful for reducing menstrual pain and cramps"),
        HealthTip(tip: 'Yoga and mindfulness meditation', author: 'Manan', content: "If you are stressed, you are more likely to suffer severe symptoms of PMS and experience poorer quality of life. Regular relaxation may be helpful in reducing severe PMS. Yoga has been used for thousands of years as a wholistic approach to health and wellbing. Some women may find yoga helpful in easing menstrual pain."),
        HealthTip(tip: 'Herbal remedies and Massage', author: 'Bhavna', content: "Some herbal remedies may have benefits for women with PMS. It's very important to check with your doctor that it is safe to use herbal remedies and treatments, particularly if you are taking other medication.A small study found that weekly massages over five weeks improved the level of pain and mood disorders and reduced fluid retention experienced by women during their menstrual cycle."),
